...
# Plot1
with (HH2, plot(Time, Global_active_power, type="l", ylab="Global Active Power"))

# Plot2
with (HH2, plot(Time, Voltage, type="l", ylab="Voltage"))
...
legend("topright", col=c("black","red","blue"), lwd=1, legend=names(HH2)[7:9], cex=0.6)

# Plot4
with (HH2, plot(Time, Global_reactive_power, type="l", ylab="Global_reactive_power"))
